...
private val DarkColors = darkColorScheme(
    ...
    // Left unset, Material invents a purple tonal container that fights the
    // accent; tonal buttons are the primary action here so they stay in family.
    secondaryContainer = Color(0xFF16302A),
    onSecondaryContainer = Accent,
    tertiary = Color(0xFF8AA6B4),
    tertiaryContainer = Color(0xFF1A1F27),
    onTertiaryContainer = Color(0xFFA6B0BE),
...
private val LightColors = lightColorScheme(
    ...
    secondaryContainer = Color(0xFFD3F3E3),
    onSecondaryContainer = Color(0xFF04301F),
    tertiary = Color(0xFF44606E),
    tertiaryContainer = Color(0xFFEDF1F5),
    onTertiaryContainer = Color(0xFF48525E),
